...
\question*{One-Way Property versus Collision-Free Property}
\begin{alphaparts}
    \questionpart{It took an average of 23,129,812 attempts to crack the one-way
    property}
    \questionpart{For the collision-free property, it took an average of 28,742
    attempts to crack it.}
    \questionpart{We can assume that it is easier to break the collision-free
    property based off these test results.}
\end{alphaparts}
